...
export default {
  data () {
    return {
      data: [70, 45, 80, 85, 60, 55, 32, 50, 45, 33, 61, 79, 53, 46, 74, 40, 26, 80, 56, 36],
      total: '',
      average: '',
      highest: '',
      lowest: ''
  ...
  methods: {
    drawLine () {
      ...
      myChart.setOption({
        ...
        tooltip: {},
        xAxis: {
          data: ['J.Jones', 'B.Alpha', 'D.Dong', 'R.Smith', 'K.Johnson', 'L.Brown', 'N.Williams', 'R.Wong', 'A.Clinton', 'E.Miller', 'F.Davis', 'M.Garcia', 'H.Wilson', 'C.White', 'R.Clark', 'W.Lewis', 'Z.Walker', 'T.Perez', 'Z.Lopez', 'Y.Martin']
        },
        yAxis: {},
        series: [
          {
