        ...
        <div class="box">
          <div class="circle2">
              <div class="font">
               ...
               <p style="color:green;font-size:26px;font-weight:bold;margin-top:10px;">-0.07%</p>
              </div>
          </div>
        </div>
        <div class="box">
...
export default {
  data () {
    return {
      data: [1500, 3560, 2406, 4525, 4196, 5933, 3201, 4985, 5017, 4205, 6229, 4219, 5604, 2517, 1297, 4139],
      total: '',
      average: '',
      highest: '',
      lowest: ''
  ...
  methods: {
    drawLine () {
      ...
      myChart.setOption({
        title: {
          text: 'Heart Disease by District Last Year'
        },
        tooltip: {},
        xAxis: {
